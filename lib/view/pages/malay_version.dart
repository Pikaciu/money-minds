...
class MalayVersion extends StatefulWidget {
  const MalayVersion({Key? key}) : super(key: key);

  @override
  State<MalayVersion> createState() => _MalayVersionState();
}

class _MalayVersionState extends State<MalayVersion> {
//fetch user date
        ...
        builder: (BuildContext ctx, AsyncSnapshot snapshot) {
          ...
          if (snapshot.connectionState == ConnectionState.done) {
            ...
            if (snapshot.hasData) {
              ...
              return Scaffold(
                appBar: AppBar(
                  title: const Text("Malay Version"),
