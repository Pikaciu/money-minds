...
import 'package:money_minds/view/pages/profile_page_for_caregiver.dart';
...
class BottomNavigationBarForCaregiverScreen extends StatefulWidget {
  const BottomNavigationBarForCaregiverScreen({Key? key}) : super(key: key);
  @override
  _BottomNavigationBarForCaregiverScreenState createState() =>
      _BottomNavigationBarForCaregiverScreenState();
}

class _BottomNavigationBarForCaregiverScreenState
    extends State<BottomNavigationBarForCaregiverScreen> {
  List? _pages;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //           context,
      //           MaterialPageRoute(
      //               builder: (context) => ProfilePageForSidebar()),
      //         );
      //       },
      //     ),
      //     ListTile(
